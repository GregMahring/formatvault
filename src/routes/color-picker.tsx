  ...
  return (
    <div className="flex items-center gap-3 border-b border-gray-800 py-3 last:border-0">
      ...
      <button
        ...
        className="flex shrink-0 items-center gap-1.5 rounded border border-gray-700 bg-gray-800 px-2.5 py-1 text-xs text-gray-400 transition-colors hover:border-gray-600 hover:text-gray-200"
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-gray-800 bg-gray-950 px-4 py-2">
        <Pipette className="h-4 w-4 text-gray-500" aria-hidden="true" />
        <h1 className="text-sm font-semibold text-gray-200">Color Picker</h1>
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-6 overflow-y-auto p-6">
        ...
        <section>
          ...
          <div className="flex items-start gap-4">
            ...
            <div
              className={cn(
                'relative h-16 w-16 shrink-0 cursor-pointer overflow-hidden rounded-lg border border-gray-700 transition-colors',
                !color && 'bg-gray-800'
              )}
            ...
            <div className="flex flex-1 flex-col gap-1.5">
              <input
                ...
                className={cn(
                  'w-full rounded border bg-gray-900 px-3 py-2 font-mono text-sm text-gray-200 placeholder-gray-600 focus:outline-none',
                  inputError
                    ? 'border-red-800 focus:border-red-700'
                    : 'border-gray-700 focus:border-accent-500'
                )}
                spellCheck={false}
                autoComplete="off"
